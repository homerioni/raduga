...
export const ModalProductContent = ({ data, refetch }: TModalProductContentProps) => {
            ...
            <Grid.Col span={{ base: 12, sm: 6 }}>
              {categories && (
                <Select
                  ...
                  onChange={(_, option) => setValue('categoryId', +option.value)}
            ...
            <Grid.Col span={{ base: 6, sm: 3 }}>
              <Input.Wrapper label="Наличие">
                <SegmentedControl
                  ...
                  data={stockInputs}
                  defaultValue={typeof data?.stock === 'boolean' ? ['0', '1'][+data.stock] : '2'}
